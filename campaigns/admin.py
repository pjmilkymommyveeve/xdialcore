...
from .models import (
    Model, Campaign, CampaignModel, Voice, CampaignVoiceStats,
    CampaignRequirements, Status, StatusHistory,
    PrimaryDialer, CloserDialer, DialerSettings,
...
# ============================================================================
# SECTION 3: STANDALONE MODELS (Campaign, Model, Voice)
# ============================================================================
...
# ============================================================================
# SECTION 7: CLIENT CAMPAIGNS (Main Interface with Inline Dialers)
# ============================================================================
...
class ClientCampaignModelForm(forms.ModelForm):
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'start_date': forms.DateTimeInput(attrs={'type': 'datetime-local', 'class': 'vDateField'}),
            'end_date': forms.DateTimeInput(attrs={'type': 'datetime-local', 'class': 'vDateField'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['status_history'].queryset = StatusHistory.objects.select_related('status').order_by('-start_date')
